...
namespace CourseInfo
{
    public partial class Report : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-Q3KCJHO;Initial Catalog=C:\USERS\IMN99\ONEDRIVE\DESKTOP\DATABASE\DBPROJECT.MDF;Integrated Security=True");
        public Report()
        {
            InitializeComponent();
            FillcomboCourse();
